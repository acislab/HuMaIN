...
DIR_OCROPY = "/home/ialzuru/ocropus/ocropy"
N_THREADS = 6
...
# python ~/Spring2019/ALOT/recognizeDir_mt.py -if ./BinarizationProblem -mf ~/ocropus/ocropy/models -mn en-default.pyrnn.gz -p True
#----------------------------------------------------------------------------------------------------------------------------------------------------------------
#----------------------------------------------------------------------------------------------------------------------------------------------------------------
