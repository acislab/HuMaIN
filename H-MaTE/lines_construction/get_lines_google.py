...
if __name__ == '__main__':
	""" Extract the blocks from a image (jpg) file using Google Cloud Text Detection.
	"""
	parser = argparse.ArgumentParser("Extract the blocks from a image (jpg) file using Google Cloud Text Detection.")
	...
	parser.add_argument('-of', '--output_file', action="store", required=True, help="Path + Filename of the text file which will save the coordinates of the cropped blocks.")
