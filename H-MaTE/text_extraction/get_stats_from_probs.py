...
if __name__ == '__main__':
	...
	for filename in files_list:
		...
		df = None
		try:
			#df = pd.read_csv( path_filename, sep="\t", header=None, engine='python', encoding='ascii', quoting=csv.QUOTE_NONE )
			#df = pd.read_csv( path_filename, sep="\t", header=None, engine='python', quoting=csv.QUOTE_NONE )			
