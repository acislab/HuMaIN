...
# python3 ~/Spring2019/ALOT/build_labels.py -r ~/Spring2019/H-MaTE/biocolls/aocr_entomology/images -i ~/Spring2019/H-MaTE/biocolls/aocr_entomology/H-MaTE/final_txt_prob -o ~/Spring2019/H-MaTE/biocolls/aocr_entomology/H-MaTE/final_labels
#----------------------------------------------------------------------------------------------------------------------------------------------------------------
if __name__ == '__main__':
	""" Using the final .txt files, after executing the Text Extraction process, this program rebuilds the trasncribed text for the images.
	"""
	parser = argparse.ArgumentParser("Using the final .txt files, after executing the Text Extraction process, this program rebuilds the trasncribed text for the images.")
